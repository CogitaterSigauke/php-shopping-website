  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#laptop">Clothing</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#pc">Accessories</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#maker">Shoes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#maker">SignOut</a>
          </li>
        </ul>
      </div>
    </div>
